...
/// octopus-sdk-android-private#267 + octopus-sdk-swift-private#287), so
...
class _InitialScreenScenarioState extends State<InitialScreenScenario> {
  ...
  /// (per the pm-tools `test-environments.yaml` fixtures). Falls back to the
          ...
          onRun: (setResult) async {
            ...
            try {
              ...
              setResult(
                ...
                '(tracked: octopus-sdk-android-private#267, '
                'octopus-sdk-swift-private#287). Image bytes are '
              ...
              // octopus-sdk-android-private#267 + octopus-sdk-swift-private#287.
